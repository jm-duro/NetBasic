...
constant a_address = allocate(16), b_address = a_address + 4,
	 c_address = b_address + 4, d_address = c_address + 4,
	 data_address = allocate(64)

constant md5asm = allocate (1679)
...
--<function>
--<name>md5</name>
--<digest>Given a string, returns a 16-byte hash of it.</digest>
--<desc></desc>
--<param>
--<type>sequence</type>
--<name>message</name>
--<desc>string to compute</desc>
--</param>
--<return>
-- sequence of 16-byte hash
--</return>
--<example>
-- whole_file = read_file(filename)
-- return hex_string(md5(whole_file))
--</example>
--<see_also>md5sum()</see_also>
--</function>
