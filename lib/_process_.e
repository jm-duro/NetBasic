...
--<digest>returns a list of Process IDs (PID) which command line matches given name</digest>
--<desc></desc>
--<param>
--<type>sequence</type>
--<name>processname</name>
--<desc>name of the process to check</desc>
--</param>
--<return>
...
--<digest>Checks if a process of given name is running</digest>
--<desc></desc>
--<param>
--<type>sequence</type>
--<name>processname</name>
...
-- end if
--</example>
--<see_also>get_process_id()</see_also>
--</function>
  sequence processes
